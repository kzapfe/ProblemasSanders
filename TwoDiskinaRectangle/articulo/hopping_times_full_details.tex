...
elastic collisions either with a wall of the box, or with one another; this has been called ``inertial motion'' (to distinguish it from Brownian motion) REF, and can be thus be thought of as a billiard model \cite{Buni2007}.
...
statistical physics and nonlinear dynamics \cite{SzasBook00},
