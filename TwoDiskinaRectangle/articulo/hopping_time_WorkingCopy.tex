...
the excluded volume, instead of the avaible one.
Our general integral is then
...
\end{split}
\end{equation}
A diagram help us to set right the limits of integration.
In the figure \ref{diaglimites} we show the tree posible cases:
\begin{figure}[h]
        \centering
