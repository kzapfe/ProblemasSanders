...
%\caption{Volume?? $V_\text{cyl}$ of exclusion cylinder, compared
...
%%Scripts
\end{equation}
Also of interest is the limit $r\sim a/4$, where vertical hopping becomes
...
which
predicts the same exponent for the behaviour of this hopping time. IS ONLY THE EXPONENT THE SAME OR THE WHOLE EXPRESSION? THEY ARE DOING FIRST PASSAGE TIME. The figures
2 and 4 of their article correspond to that regime.
\pmb{ YES. ONLY THE EXPONENT. It is to be EXPECTED}
...
Lastly, for wall collisions we obtain
