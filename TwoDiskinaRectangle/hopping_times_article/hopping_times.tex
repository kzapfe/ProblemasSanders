...
Event times are the return time to
a certain surface of section of the phase space. We expect then the
usual exponential distribution for return times of hard chaotic sistems
\cite{Hirata1999}. It is also known that deviation from the
exponential depend on the particular qualites of the system at hand
\cite{Altmann2005}.
...
distribution depends both cualitatively and quantitatively on the
radius, with the expected exponential decay on the middle range
of the distribution. 
