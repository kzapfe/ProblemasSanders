...
results for the kinetics of the inertial motion of 
...
against mean first event times.
\end{abstract}
...
in which two particles interchange position, and the other
...
They use heuristic arguments to provide expressions for the
...
Our intention is
to find primarly the first hopping and collition times of the two disks under 
inertial motion, as a closed analytical expression dependant only
on the geometric parameters of the system.
This turns out to be feasible because  
the reduced model proposed in \cite{Bowles04}
is a hard sphere billiard. 
Such systems  are one of the most recurred models in
statistical physics and non linear dynamics.  
...
\begin{figure}[h]
\centering
\includegraphics[width=0.8\textwidth]{AreaHopp002.pdf}
